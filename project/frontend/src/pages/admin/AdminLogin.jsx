    ...
    <AdminLoginWrapper>
      ...
      >
        <AdminLogo>
          ...
          <h1 style={{ fontSize: '1.75rem', fontWeight: 800, letterSpacing: '-1.5px' }}>Terminal Admin</h1>
        </AdminLogo>
        
        <AdminCard>
          <FormTitle>Executive Login</FormTitle>
          <FormSubtitle>Access the StartupFund oversight terminal.</FormSubtitle>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button 
              type="submit" 
              disabled={loading}
              style={{ width: '100%', marginTop: '1rem', background: '#38bdf8', color: '#0f172a' }}
            >
          ...
          <Button 
            variant="outline" 
            style={{ width: '100%', marginTop: '1.5rem', borderColor: '#334155', color: '#94a3b8' }}
            onClick={() => navigate('/')}
          >
            <ArrowLeft size={16} style={{ marginRight: 8 }} /> Return to Main Ecosystem
          </Button>
        </AdminCard>
      </motion.div>
    </AdminLoginWrapper>
